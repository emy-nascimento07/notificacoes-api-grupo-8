...
Evento.hasMany(Inscricao, { foreignKey: "evento_id", as: "inscricoes" });  // 'hasMany': cria evento_id na tabela inscricoes,'as': apelido para consultas
Inscricao.belongsTo(Evento, { foreignKey: "evento_id", as: "evento" }); // 'Belongs to': define a FK evento_id
